...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, H, W):
        ...
        if self.shift_size > 0:
            ...
            attn_mask = None  # For simplicity, not implementing mask here
        else:
            shifted_x = x
            attn_mask = None
...
class PatchMerging(nn.Module):
    """ Patch Merging Layer - Critical for Swin Transformer """
...
class SwinTransformerDeepfake(nn.Module):
